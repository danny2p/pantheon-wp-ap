...
class WPRM_SC_Jump extends WPRM_Template_Shortcode {
	...
	public static function shortcode( $atts ) {
		...
		$output = '<a href="#wprm-recipe-container-' . esc_attr( $recipe->id() ) . '" data-recipe="' . esc_attr( $recipe->id() ) . '" style="' . esc_attr( $style ) . '" class="' . esc_attr( implode( ' ', $classes ) ) . '"' . $smooth_scroll_speed . $aria_label . '>' . $icon . wp_kses_post( $text ) . '</a>';
